// public/input.jsx
const Input = window.React.forwardRef(function Input(props, _ref) {
  const {
    value: propsValue,
  ...
  window.React.useEffect(() => {
    if (setRawValue) setRawValue(currentValue);
  ...
  const onChange = (event) => {
    if (readOnly) return;
    if (wrappedProps.disabled) return;
    if (cooldownDuration) {
  ...
  return window.jsxRuntime.jsx(
    ...
    Object.assign({}, containerProps, {
      ...
      children: window.jsxRuntime.jsx("div", {
        children: [
          stretch &&
            window.jsxRuntime.jsx("div", Object.assign({
