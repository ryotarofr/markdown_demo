...
export function Test() {
  // Typeはstringなんでもいける
  // node は children: [{ type: 'a', value: 'AAAAAAA' }] の部分をさす
  // parent は　node　が持っているオブジェクト全てを返す
  visit(tree, 'a', (node, index, parent) => {
    console.log('Found text node:', node.value, parent.type)
  })
}
